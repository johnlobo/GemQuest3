...
u8 const swapColorsM0[6][4] = {   
    {0x40, 0x80, 0xC0, 0x94},   // Bright White 
    {0x01, 0x02, 0x03, 0x16},   // Bright Yellow
    {0x54, 0xa8, 0xFC, 0xBC},   // Orange
    {0x44, 0x88, 0xCC, 0x9C},   // Blue
    {0x04, 0x08, 0x0C, 0x1C},   // Bright Red
    {0x51, 0xa2, 0xF3, 0xB6}    // Mauve
    };
